...
namespace CSharpHomework
{
    public class Problem4
    {
        ...
        public static int EnBuyukBul(int[] dizi)
        {
            if (dizi.Length == 0) return 0;
            int enBuyuk = dizi[0];
            foreach (int sayi in dizi) if (sayi > enBuyuk) enBuyuk = sayi;
            return enBuyuk;
        }
        ...
        public static int EnKucukBul(int[] dizi)
        {
            if (dizi.Length == 0) return 0;
            int enKucuk = dizi[0];
            foreach (int sayi in dizi) if (sayi < enKucuk) enKucuk = sayi;
            return enKucuk;
        }
        ...
        public static List<int> CiftSayilariFiltrele(int[] dizi)
        {
            ...
            foreach (int sayi in dizi) if (sayi % 2 == 0) ciftler.Add(sayi);
            return ciftler;
        }
        ...
        {
            int sayac = 0;
            foreach (int sayi in dizi) if (sayi == aranan) sayac++;
            return sayac;
        }
    }
}